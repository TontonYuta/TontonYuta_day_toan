...
*Ví dụ:* $2 < 5$, $9 > 4$.`,
  ...
  "2": {
    ...
    chapters: [
      {
        id: "c1_2",
        title: "Chương 1: Phép cộng có nhớ",
        sessions: [
          {
            id: "s1_2",
  ...
  "5": {
    ...
    chapters: [
      {
        id: "c1_5",
        title: "Chương 1: Phân số & Số thập phân",
        sessions: [
          {
            id: "s1_5",
    ...
    chapters: [
      {
        id: "c1_6",
        title: "CHƯƠNG 1. SỐ TỰ NHIÊN",
        description: "Làm quen với tập hợp, các phép toán trên tập số tự nhiên và tính chia hết.",
        sessions: [
          {
            id: "s1_6",
...
Lũy thừa $\\rightarrow$ Nhân và Chia $\\rightarrow$ Cộng và Trừ.`,
      ...
      },
      {
        ...
        description: "Mở rộng tập số tự nhiên sang số nguyên, quy tắc dấu ngoặc và phép toán trên số nguyên.",
        sessions: [
           {
             id: "s4_6",
             title: "Buổi 4: Làm quen với số nguyên",
             description: "Số nguyên âm, tập hợp số nguyên Z, trục số.",
             theory: `### 1. Số nguyên âm
- Số nguyên âm được ghi bằng dấu trừ "-" trước số tự nhiên khác 0.
- VD: -1, -2, -3...
- Dùng để chỉ nhiệt độ dưới 0 độ C, độ sâu dưới mực nước biển, số tiền nợ...
...
- VD: Số đối của 5 là -5. Số đối của -3 là 3. Số đối của 0 là 0.`,
             examples: [],
             essays: [],
             mcqs: [],
             review: "Số 0 không là số nguyên âm cũng không là số nguyên dương."
           }
        ]
      },
      {
      ...
      {
        id: "c5_6",
        title: "CHƯƠNG 5. HÌNH HỌC (CƠ BẢN)",
        sessions: []
      },
      {
        id: "c6_6",
        title: "CHƯƠNG 6. THỐNG KÊ VÀ XÁC SUẤT",
        sessions: []
      }
    ]
  },
