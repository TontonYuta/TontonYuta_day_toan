      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-8">
           <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="bg-gradient-to-r from-yellow-400 to-orange-500 p-6 text-white text-center relative">
              ...
              <div className="p-4">
                 {leaderboardData.map((user, idx) => {
                    ...
                    if (isTop1) rankBg = "bg-yellow-100 text-yellow-700";
                    if (isTop2) rankBg = "bg-gray-200 text-gray-700";
                    if (isTop3) rankBg = "bg-orange-100 text-orange-700";

                    return (
                       <div key={user.id} className="flex items-center gap-3 p-3 hover:bg-gray-50 rounded-xl transition-colors mb-2">
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm ${rankBg}`}>
                             {idx + 1}
                          </div>
                          <div className="h-10 w-10 rounded-full bg-gradient-to-tr from-blue-100 to-blue-200 p-[2px]">
                          ...
                          <div className="text-right">
                             <span className="font-bold text-indigo-600">{user.xp}</span>
                             <span className="text-[10px] text-gray-400 uppercase ml-1">XP</span>
                          </div>
                       </div>
                    );
                 })}
         ...
         <div className="max-w-7xl mx-auto text-center relative z-10">
            ...
            <div className="max-w-2xl mx-auto mb-10 relative">
               <div className="relative">
                 ...
                 <input 
                   type="text"
                   className="block w-full pl-10 pr-3 py-4 border border-gray-200 rounded-full leading-5 bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary shadow-lg transition-all"
               ...
               {searchTerm && (
                 <div className="absolute z-50 w-full mt-2 bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden text-left">
                    {searchResults.length > 0 ? (
                      <div>
                        <div className="px-4 py-2 bg-gray-50 text-xs font-bold text-gray-500 uppercase tracking-wider">Kết quả tìm kiếm</div>
                        {searchResults.map((item) => (
                          ...
                          >
                             ...
                             <div className="text-xs text-gray-500 flex items-center gap-2 mt-1">
                               <span className="bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded">{item.gradeName}</span>
...
const SessionPage = () => {
  ...
  return (
    <div className="flex flex-col gap-6 relative">
      ...
      {/* Tabs Navigation */}
      <div className="sticky top-16 z-30 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 py-2 no-print">
